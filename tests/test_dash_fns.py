import pdb
from dash_fns import calc_av_rest, check_hr_formatting, check_rest_formatting, check_sr_formatting, find_team_id, find_wo_name, format_and_post_intervals, generate_post_wo_dict2, get_name, get_wo_details, post_new_team, post_newuser, check_date, check_duration, reformat_date, seconds_to_duration, validate_form_inputs, duration_to_seconds, wo_details_df, get_usernames, flask_client_get as client_get, flask_client_post as client_post, get_id
...
def test_07_check_duration():
    ...
    assert check_duration('15:00')['success'] == True
